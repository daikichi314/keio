...
# 出力ファイルヘッダーの作成
echo "Voltage Gain_ch00 Gain_ch01 Gain_ch02 Gain_ch03" > /home/daiki/lab/data/20250809/HV_vs_gain2.txt
...
do
    ...
    # ファイル名を定義（0を追加）###0829変更 ここ変えるべきかも
    ...
    ./simplefit ${input_file} ${output_fit_file} 2 0  ####0829変更 peformance1pe.C
    ...
    # 電圧とゲインの値をHV_vs_gain2.txtに追記
    echo "${voltage} ${gain_ch00} ${gain_ch01} ${gain_ch02} ${gain_ch03}" | sed 's/,//g' >> /home/daiki/lab/data/20250809/HV_vs_gain2.txt

    # 次のループのために電圧を更新
    voltage=$((voltage + increment))
done

echo "Processing complete. The result is saved in /home/daiki/lab/data/20250809/HV_vs_gain2.txt"
